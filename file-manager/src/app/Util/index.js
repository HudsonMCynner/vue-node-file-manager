...
import Vue from 'vue'
import { get, isEmpty, isEqual, set, isNull } from 'lodash'
 ...
 * @returns {*[]}
 */
export const groupArrayByProps = function (arrayList = [], props = [], returnAs = 'array') {
 ...
 * @returns {array}
 */
export const arraySort = function (array, sortParam) {
  return array.sort((a, b) => prop(a, sortParam) < prop(b, sortParam) ? -1 : prop(a, sortParam) > prop(b, sortParam) ? 1 : 0)
}
