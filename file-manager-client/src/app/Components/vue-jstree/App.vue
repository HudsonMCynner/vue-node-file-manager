    ...
    <div>
      <div style="width:840px; margin: 0 auto;">
        <div style="width:49%; display:inline-block; vertical-align: top;">
          ...
          <br>
          <span
            style="float: left; background-color: red; color: #fff; padding: 6px"
            draggable="true"
          >
    ...
    <div>
      <div style="width:840px; height:300px; margin: 0 auto;">
        <table>
          ...
          <tr>
            <td colspan="2">
              <button @click="addChildNode">
                add child node
              </button>
              <button @click="removeNode">
                remove this node
              </button>
              <button @click="addBeforeNode">
                add child before node
              </button>
              <button @click="addAfterNode">
                add child after node
              </button>
              <button @click="openChildren">
                open child node
              </button>
              <button @click="closeChildren">
                close child node
              </button>
            </td>
          </tr>
